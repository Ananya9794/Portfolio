        ...
        <div  className="bg-slate-900/30 border border-slate-700/30 rounded-2xl p-8 md:p-12 grid md:grid-cols-2 gap-8">
          ...
          <div data-aos="fade-right" data-aos-delay="200">
            ...
            <div className="mt-6 space-y-3 text-sm text-slate-300">
              <div><strong>Email:</strong> <a href="mailto:sethiananya99@gmail.com">sethiananya99@gmail.com</a></div>
              <div><strong>LinkedIn: </strong> <a href="https://www.linkedin.com/in/ananya-sethi-616868295/" target='_blank'>/ananya-sethi-616868295</a></div>
              <div><strong>Github: </strong ><a href="https://github.com/Ananya9794" target='_blank' className='cursor-pointer'> /in/ananya9794</a></div>
            </div>
            <div className='flex text-3xl gap-3 pt-7 text-slate-400'>
              <a href="https://github.com/Ananya9794" target='_blank'><FaGithub /></a>
              <a href="https://www.linkedin.com/in/ananya-sethi-616868295/" target='_blank'><FaLinkedin /></a>
              <a href="mailto:sethiananya99@gmail.com"><SiGmail /></a>
            </div>
          </div>
