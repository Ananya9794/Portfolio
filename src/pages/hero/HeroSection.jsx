    ...
    {roles[currentRole]}</span>
        ...
        <div className="relative flex items-center md:justify-end " >
          ...
          <div className="w-56 h-56 rounded-full overflow-hidden">
            <img src="/ananya-img3.jpg" alt="profile" className="w-56 h-56 rounded-full object-cover ring-4 ring-transparent/10 transition-transform duration-700 ease-in-out group-hover:scale-110"  data-aos="zoom-in" data-aos-delay="200"/>
          </div>
